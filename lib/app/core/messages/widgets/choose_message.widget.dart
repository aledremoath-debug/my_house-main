...
class ChooseMessage extends StatelessWidget {
  final String message;
  final bool isInfo;
  const ChooseMessage({super.key, required this.message, this.isInfo = false});
      ...
      child: Row(
        children: [
          ...
          Container(
            ...
            child: Icon(Icons.priority_high, color: Colors.white, size: 28.sp),
          ),
          SizedBox(width: 12.w),
          // Text
          Expanded(
